...
<body>
    <div class="dashboard-container">
        ...
        <div class="profile-card">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 text-center">
                    <a href="index.php?action=profil" class="btn btn-light btn-sm mb-2 w-100">
        ...
        <div class="table-card">
            ...
            <!-- DataTable with HOVER, STRIPED, CONDENSED -->
            <table id="userTable" class="table table-striped table-hover table-sm table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button class="btn btn-primary btn-sm btn-action" onclick="viewProfile(<?= $match['id'] ?>)">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#userTable').DataTable({
                // DOM positioning: B = Buttons, f = filter, r = processing, t = table, i = info, p = pagination
                dom: 'Bfrtip',
                ...
                buttons: [
                    {
                        ...
                        exportOptions: {
                            columns: [0, 2, 3, 4, 5, 6, 7, 8, 9] // Exclude foto dan aksi
                        }
                    },
                    {
                        extend: 'pdf',
                        ...
                        pageSize: 'A4',
                        exportOptions: {
                            columns: [0, 2, 3, 4, 5, 6, 7, 8] // Exclude foto, bio, dan aksi
                        }
                    },
                    {
                        extend: 'print',
                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        targets: [0, 1, 3, 4, 10] // Center align
                    }
                ],
        ...
        // Function untuk view profile detail
        function viewProfile(userId) {
            alert('Fitur detail profile untuk user ID: ' + userId + '\nSegera hadir! 💕');
            // Nanti bisa dikembangkan untuk menampilkan modal detail profil
        }
    </script>
</body>
</html>